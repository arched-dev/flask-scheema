...
def test_return_callback_get():
    session["test_get"] = "test_get"


def test_return_callback_post():
    session["test_patch"] = "test_patch"
...
class Author(db.Model):
    ...
    # By default, any field starting with an underscore is ignored by flask-scheema. To change this behavior, set the
    # `API_IGNORE_UNDERSCORE_ATTRIBUTES` to `False` in the app's configuration.
    _hidden_field: Mapped[Optional[str]] = mapped_column(
        String,
        info={
    ...
    def full_name(self) -> str:
        """
        Hybrid properties are picked up by flask-scheema also.
        Returns:
