...
xxx  {x} - API_CONVERT_TO_CAMEL_CASE:             Optional[callable] = True # Convert json output to camel case
xxx    - API_ALLOW_CASCADE_DELETE:                   Optional[callable] = True # When True, will not cascade delete on
